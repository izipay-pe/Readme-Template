...
Reemplace **[CHANGE_ME]** con sus credenciales de `API REST` extraídas desde el Back Office Vendedor, resivar aparatdo [2. Requisitos Previos](#2. Requisitos Previos).
